...
public class AdminEnableUserRequest {
  ...
  public AdminEnableUserRequest userType(UserTypeEnum userType) {
  ...
  **/
  ...
  public AdminEnableUserRequest username(String username) {
    this.username = username;
    return this;
  }

   /**
   * The username of data which you are going to enable
   * @return username
  **/
  @Schema(example = "Jack", required = true, description = "The username of data which you are going to enable")
  ...
  if (o == null || getClass() != o.getClass()) {
    ...
    AdminEnableUserRequest adminEnableUserRequest = (AdminEnableUserRequest) o;
    return ObjectUtils.equals(this.userType, adminEnableUserRequest.userType) &&
    ObjectUtils.equals(this.username, adminEnableUserRequest.username);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdminEnableUserRequest {\n");

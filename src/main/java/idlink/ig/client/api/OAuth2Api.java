...
public class OAuth2Api {
    ...
    /**
     * Build call for oAuth2AuthorizeGetCode
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call oAuth2AuthorizeGetCodeCall(String redirectUri, String state, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/oauth2/authorize/codeOnly";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call oAuth2AuthorizeGetCodeValidateBeforeCall(String redirectUri, String state, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {

        com.squareup.okhttp.Call call = oAuth2AuthorizeGetCodeCall(redirectUri, state, authorization, progressListener, progressRequestListener);
        return call;
     ...
     * @param state  (optional)
     * @param authorization Authorization, Get form ID.LINK team. (optional)
     * @return OAuth2GetReqCodeResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public OAuth2GetReqCodeResponse oAuth2AuthorizeGetCode(String redirectUri, String state, String authorization) throws ApiException {
        ApiResponse<OAuth2GetReqCodeResponse> resp = oAuth2AuthorizeGetCodeWithHttpInfo(redirectUri, state, authorization);
        return resp.getData();
    }
     ...
     * @param state  (optional)
     * @param authorization Authorization, Get form ID.LINK team. (optional)
     * @return ApiResponse&lt;OAuth2GetReqCodeResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<OAuth2GetReqCodeResponse> oAuth2AuthorizeGetCodeWithHttpInfo(String redirectUri, String state, String authorization) throws ApiException {
        com.squareup.okhttp.Call call = oAuth2AuthorizeGetCodeValidateBeforeCall(redirectUri, state, authorization, null, null);
        Type localVarReturnType = new TypeToken<OAuth2GetReqCodeResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * oauth2 user&#x27;s getCode (asynchronously)
     *
     * @param redirectUri  (optional)
     * @param state  (optional)
     * @param authorization Authorization, Get form ID.LINK team. (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call oAuth2AuthorizeGetCodeAsync(String redirectUri, String state, String authorization, final ApiCallback<OAuth2GetReqCodeResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = oAuth2AuthorizeGetCodeValidateBeforeCall(redirectUri, state, authorization, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<OAuth2GetReqCodeResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Build call for oAuth2TmallToken
     * @param code  (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call oAuth2TmallTokenCall(String code, String grantType, String refreshToken, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/oauth2/tmall/token";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call oAuth2TmallTokenValidateBeforeCall(String code, String grantType, String refreshToken, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling oAuth2TmallToken(Async)");
        }
        // verify the required parameter 'grantType' is set
        if (grantType == null) {
            throw new ApiException("Missing the required parameter 'grantType' when calling oAuth2TmallToken(Async)");
        }
        // verify the required parameter 'refreshToken' is set
        if (refreshToken == null) {
            throw new ApiException("Missing the required parameter 'refreshToken' when calling oAuth2TmallToken(Async)");
        }

        com.squareup.okhttp.Call call = oAuth2TmallTokenCall(code, grantType, refreshToken, authorization, progressListener, progressRequestListener);
        return call;
     ...
     * @param refreshToken  (required)
     * @param authorization Authorization, Get form ID.LINK team. (optional)
     * @return OAuth2TmallResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public String oAuth2TmallToken(String code, String grantType, String refreshToken, String authorization) throws ApiException {
        ApiResponse<String> resp = oAuth2TmallTokenWithHttpInfo(code, grantType, refreshToken, authorization);
        return resp.getData();
    }
     ...
     * @param refreshToken  (required)
     * @param authorization Authorization, Get form ID.LINK team. (optional)
     * @return ApiResponse&lt;OAuth2TmallResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> oAuth2TmallTokenWithHttpInfo(String code, String grantType, String refreshToken, String authorization) throws ApiException {
        com.squareup.okhttp.Call call = oAuth2TmallTokenValidateBeforeCall(code, grantType, refreshToken, authorization, null, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * oauth2 user&#x27;s token for tmall (asynchronously)
     *
     * @param code  (required)
     * @param grantType  (required)
     * @param refreshToken  (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call oAuth2TmallTokenAsync(String code, String grantType, String refreshToken, String authorization, final ApiCallback<OAuth2TmallResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = oAuth2TmallTokenValidateBeforeCall(code, grantType, refreshToken, authorization, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<OAuth2TmallResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call oAuth2TokenCall(String clientId, String clientSecret, String code, String grantType, String password, String redirectUri, String refreshToken, String username, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call oAuth2TokenValidateBeforeCall(String clientId, String clientSecret, String code, String grantType, String password, String redirectUri, String refreshToken, String username, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'clientId' is set
        if (clientId == null) {
            throw new ApiException("Missing the required parameter 'clientId' when calling oAuth2Token(Async)");
        }
        // verify the required parameter 'clientSecret' is set
        if (clientSecret == null) {
            throw new ApiException("Missing the required parameter 'clientSecret' when calling oAuth2Token(Async)");
        }
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling oAuth2Token(Async)");
        }
        // verify the required parameter 'grantType' is set
        if (grantType == null) {
        ...
        if (redirectUri == null) {
            throw new ApiException("Missing the required parameter 'redirectUri' when calling oAuth2Token(Async)");
        }
        // verify the required parameter 'refreshToken' is set
        if (refreshToken == null) {
        ...
        com.squareup.okhttp.Call call = oAuth2TokenCall(clientId, clientSecret, code, grantType, password, redirectUri, refreshToken, username, authorization, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public OAuth2LoginResponse oAuth2Token(String clientId, String clientSecret, String code, String grantType, String password, String redirectUri, String refreshToken, String username, String authorization) throws ApiException {
        ApiResponse<OAuth2LoginResponse> resp = oAuth2TokenWithHttpInfo(clientId, clientSecret, code, grantType, password, redirectUri, refreshToken, username, authorization);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<OAuth2LoginResponse> oAuth2TokenWithHttpInfo(String clientId, String clientSecret, String code, String grantType, String password, String redirectUri, String refreshToken, String username, String authorization) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call oAuth2TokenAsync(String clientId, String clientSecret, String code, String grantType, String password, String redirectUri, String refreshToken, String username, String authorization, final ApiCallback<OAuth2LoginResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = oAuth2TokenValidateBeforeCall(clientId, clientSecret, code, grantType, password, redirectUri, refreshToken, username, authorization, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<OAuth2LoginResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Map<String, Object> openidConfiguration() throws ApiException {
        ApiResponse<Map<String, Object>> resp = openidConfigurationWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Map<String, Object>> openidConfigurationWithHttpInfo() throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call openidConfigurationAsync(final ApiCallback<Map<String, Object>> callback) throws ApiException {
